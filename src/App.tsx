...
const faqs = [
  ...
  ["Quais cidades vocês atendem?", "Atendemos um raio aproximado de 18 km a partir do CEP 09820-770, incluindo São Bernardo do Campo e cidades do ABC. Serra de Santos, Praia Grande, Cubatão, Guarujá e outras regiões são atendidas conforme disponibilidade de rota."],
...
const localBusinessSchema = {
  ...
  address: { "@type": "PostalAddress", streetAddress: "R. José D'Ângelo, 574 - Parque Terra Nova II", addressLocality: "São Bernardo do Campo", addressRegion: "SP", postalCode: "09820-770", addressCountry: "BR" },
