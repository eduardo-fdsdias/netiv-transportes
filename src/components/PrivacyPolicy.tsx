...
export function PrivacyPolicy() {
  return <main className="legal-page">
    <article>
      ...
      <p>O site oferece links para WhatsApp e Instagram, incorpora um mapa do Google e utiliza as tags do Google Ads e Google Analytics para medir visitas e interações. Quando aplicável, a origem da visita é mantida temporariamente nesta aba e acrescentada como uma referência curta na mensagem preparada para o WhatsApp. Isso permite distinguir contatos vindos de anúncios, pesquisa orgânica ou acesso direto, sem criar cadastro ou CRM. Esses serviços podem usar cookies ou identificadores semelhantes conforme as políticas do Google e das respectivas empresas. Não vendemos dados pessoais.</p>
